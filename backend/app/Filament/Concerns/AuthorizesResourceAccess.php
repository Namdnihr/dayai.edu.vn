...
trait AuthorizesResourceAccess
{
    ...
    protected static function permissionNameForResource(): ?string
    {
        ...
        $permissionMap = [
            ...
            'AutomationLogResource' => 'manage_admin',
            'AutomationMessageResource' => 'manage_admin',
            'AutomationWorkflowResource' => 'manage_admin',
            ...
            'QuestionBankResource' => 'manage_learning',
            'QuestionResource' => 'manage_learning',
            'QuizAttemptResource' => 'manage_progress',
